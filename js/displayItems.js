	...
	fetch("/data/product.json").then((response)=>
		...
		for(let k in myObject)
		{
			if(myObject[k].filter_id===filter_id)
			{
					...
					for(let o in slidebar)
					{
						slidebar[o].innerHTML=""	
					}
					
						
					
					document.querySelectorAll(".slidebar")[0].innerHTML=productHTML
                                        document.querySelectorAll(".slidebar")[0].style.display="flex"
					document.querySelectorAll(".slidebar")[0].style.flexDirection="row"
					document.querySelectorAll(".slidebar")[0].style.justifyContent="space-around"
					document.querySelectorAll(".slidebar")[0].style.alignContent="space-around"
					document.querySelectorAll(".slidebar")[0].style.flexWrap="wrap"
					document.querySelectorAll(".slidebar")[0].style.padding="10px"
					document.querySelectorAll(".slidebar")[0].style.paddingTop="0px"
                                        document.querySelectorAll(".slidebar")[0].style.height="630px"
                                        let myBlocks=document.querySelectorAll(".slidebar div")
					...
					let myImages=document.querySelectorAll(".slidebar img")
					...
					let mySpan=document.querySelectorAll(".slidebar span")
					...
					mySpan[n].style.color="white"
					mySpan[n].style.margin="6px auto auto 10px"
					}
					}
					
					
					let myCartButton=document.querySelectorAll(".slidebar button")
...
function displayProduct(product)
{
	...
	<span>₹${product.price}</span><button class="float-right btn btn-warning" onclick="addToCart(${product.product_id},'${product.product_name}','${product.imgSrc}',${product.price})">Add-to-cart</button></div>`
...
function proceedPayment(total)
{
	...
	let cardDiv=`<img src="./images/Gpay.webp"><img src="./images/Credit_Card.webp"><img src="./images/visa.png"><img src="./images/mastercard.jpg">`
